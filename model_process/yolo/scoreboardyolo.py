...
from .parameter import Parameter as parms
...
class YOLO(object):
    _defaults = {
        "model_path"        : parms.scoreboard_model_path,
        "anchors_path"      : parms.scoreboardanchors_path,
        "classes_path"      : parms.scoreboardclasses_path,
        "score"             : 0.5,
        "iou"               : 0.3,
        "max_boxes"         : 100,
    ...
    def get_pred(self, image_data, input_image_shape):
        ...
        print("new_time", time.time() - d_time)
        # del self.yolo_model
        # gc.collect()
    ...
    def detect_image(self, path):
        ...
        for i, c in list(enumerate(out_classes)):
            ...
            if(score < 0.7):
                ...
                open_cv_image = open_cv_image[top:bottom,left:right]
